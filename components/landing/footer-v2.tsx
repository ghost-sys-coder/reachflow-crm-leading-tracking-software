  ...
  return (
    <footer className="bg-[#171715] text-white">
      <div className="mx-auto max-w-[1180px] px-5 py-14 sm:px-8">
        ...
        <div className="flex flex-col justify-between gap-3 pt-6 text-[11px] text-white/40 sm:flex-row"><p>© {new Date().getFullYear()} ReachFlow</p><div className="flex gap-5"><Link href="#">Privacy</Link><Link href="#">Terms</Link></div></div>
      </div>
    </footer>
  )
}
